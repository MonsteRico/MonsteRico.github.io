...
function switchColor(color) {
  switch (color) {
    case "black":
      ...
      image.src = "./documents/showcaseGifs/wall.gif";
    ...
    case "darkBrown":
      ...
      image.src = "./documents/showcaseGifs/antigrav.gif";
    ...
    case "red":
      ...
      image.src = "./documents/showcaseGifs/lavaInset.gif";
    ...
    case "orange":
      ...
      image.src = "./documents/showcaseGifs/lavaFull.gif";
    ...
    case "yellow":
      ...
      image.src = "./documents/showcaseGifs/coin.gif";
    ...
    case "darkGreen":
      ...
      image.src = "./documents/showcaseGifs/slime.gif";
    ...
    case "turquoise":
      ...
      image.src = "./documents/showcaseGifs/portal.gif";
    ...
    case "indigo":
      ...
      image.src = "./documents/showcaseGifs/blinkblock.gif";
    ...
    case "purple":
      ...
      image.src = "./documents/showcaseGifs/player1.gif";
    ...
    case "white":
      ...
      image.src = "./documents/showcaseGifs/eraser.gif";
      ...
      break;
    case "lightGrey":
      box.style.background = "#C3C3C3";
      colorName.innerHTML = "Light Grey - Platform";
      image.src = "./documents/showcaseGifs/platform.gif";
      ...
      hex.innerHTML = "#C3C3C3";
      rgb.innerHTML = "RGB(195, 195, 195)";
      colorName.style.color = "#000";
      description.style.color = "#000";
      hex.style.color = "#000";
      rgb.style.color = "#000";
    ...
    case "lightBrown":
      ...
      colorName.innerHTML = "Light Brown - Antigravity w/ Up Arrow";
      image.src = "./documents/showcaseGifs/antigrav.gif";
      description.innerHTML = "This block will reverse gravity as soon as you touch it. It works both ways regardless of what the arrow says. The arrows can be used to denote what way you are supposed to go.";
    ...
    case "pink":
      ...
      image.src = "./documents/showcaseGifs/checkpoint.gif";
    ...
    case "lightOrange":
      ...
      image.src = "./documents/showcaseGifs/movingblock.gif";
    ...
    case "brightGreen":
      ...
      image.src = "./documents/showcaseGifs/goal.gif";
    ...
    case "brightBlue":
      ...
      image.src = "./documents/showcaseGifs/ice.gif";
